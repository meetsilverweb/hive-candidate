...
import { addJobPost, getJobPreferanceById, updateJobPost } from 'src/slice/jobPreferenceSlice'
...
const EditFormForJob = ({ ID }: any) => {
  ...
  const getByIdJobPost = async () => {
    if (ID !== '' && ID) {
      ...
      dispatch(getJobPreferanceById(payload))
    }
  }
