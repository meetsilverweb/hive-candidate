...
const CreatePassword = () => {
  ...
  const handleSubmit = async (values: any) => {
    let payload = {
      employeeEmail: query.emailId,
      password: values?.confirmPassword
    }
    const res = await axios.post(`${process.env.NEXT_PUBLIC_BASE_URL}/updatePassword`, payload, {
      headers: {
                          ...
                          <OutlinedInput
                            ...
                            endAdornment={
                              <InputAdornment position='end'>
                                ...
                                >
                                  <Icon icon={confirmShowPassword ? 'tabler:eye' : 'tabler:eye-off'} fontSize={20} />
                                </IconButton>
                              </InputAdornment>
                            }
                          />
